...
from Beamformer import Beamformer_DAS
...
BF_DAS=Beamformer_DAS(**params_dict)

# perform beramformer
img_bf=BF_DAS.PerformBF(data_rf)
...
img=plt.imshow(img_bf, aspect='auto',interpolation='sinc',extent=BF_DAS.extent)
